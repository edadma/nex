...
The features deferred from v0 are split into two tiers:

- **v0.1+** — small, additive, non-breaking additions. Planned as natural follow-ups to v0 without redesigning anything in the core.
